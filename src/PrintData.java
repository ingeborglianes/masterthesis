...
public class PrintData {
    ...
    public static void printSailingTimes2(int[][][][] sailingTimes, int chosenVessel, int numberOfOperations, int numberOfVessels){
        int index=1;
        int i = 4;
        for(int t= 0; t<sailingTimes[0].length; t++) {
            for(int j = 0; j < numberOfOperations + 2*numberOfVessels; j++)
            {
                System.out.printf("%5d ", sailingTimes[chosenVessel][t][i][j]);
                }
            System.out.println();
        }
    }
