public class OperationGenerator {
    ...
    public OperationType[] createOperationTypesTest() {
        ...
        OperationType op8 = new OperationType(8, op8v1,null, null,
                0, 9, 700, 50, 3, DataGenerator.costPenalty * DataGenerator.maxSailingTime * 4, "Small installation facility");
        int[] op9v1 = new int[]{2, 3, 4, 6};
        OperationType op9 = new OperationType(9, op9v1, null, null,
                8, 0, 700, 50, 6, DataGenerator.costPenalty * DataGenerator.maxSailingTime * 4, "Easy transport of equipment to facility");int[] op6v1 = new int[]{2};
        int[] op10v1 = new int[]{2, 3, 4, 6};
        OperationType op10 = new OperationType(10, op10v1, null, null,
                0, 0, 700, 100, 2, DataGenerator.costPenalty * DataGenerator.maxSailingTime * 4, "Remove dead fish");
        int[] op12v1 = new int[]{1, 2, 3, 4, 6};
        OperationType op12 = new OperationType(12, op12v1, null, null,
                0, 0, 700, 100, 5, DataGenerator.costPenalty * DataGenerator.maxSailingTime * 4, "Inspect net ROV");
        int[] op13v1 = new int[]{1, 3};
        OperationType op13 = new OperationType(13, op13v1, null, null,
                0, 0, 700, 36, 4, DataGenerator.costPenalty * DataGenerator.maxSailingTime * 4, "Inspect net diver");
        int[] op14v1 = new int[]{2};
        OperationType op14 = new OperationType(14, op14v1, null, null,
                0, 0, 700, 36, 4, DataGenerator.costPenalty * DataGenerator.maxSailingTime, "Wash bottom ring and floating collar");
        int[] op11v1 = new int[]{2, 3, 4, 6};
        OperationType op11 = new OperationType(11, op11v1, null, null,
                0, 0, 700, 73, 4, DataGenerator.costPenalty * DataGenerator.maxSailingTime * 8, "Support wellboat");
        int[] op15v1 = new int[]{2, 3, 4, 6};
        OperationType op15 = new OperationType(15, op15v1, null, null,
                0, 0, 700, 24, 3, DataGenerator.costPenalty * DataGenerator.maxSailingTime * 4, "Support working boat");
        return new OperationType[]{op8, op9, op10, op12, op13, op14,op11};
    }
}
